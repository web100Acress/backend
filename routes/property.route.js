...
router.post("/buyInsert",upload.fields([{name:"frontImage",maxCount:1},{name:"otherImage",maxCount:20}]), BuyController.buycommercialInsert);
...
router.post("/buy/update/:id", upload.fields([{name:"frontImage",maxCount:1},{name:"otherImage",maxCount:20}]),BuyController.buycommercialUpdate);
router.delete("/buy/delete/:id", BuyController.buycommercialDelete);
//rent
router.post("/rentInsert",upload.fields([  { name: "frontImage", maxCount: 1 },   { name: "otherImage", maxCount: 20 }, ]), rentController.rentInsert);
...
router.post("/:id/rentUpdate",upload.fields([  { name: "frontImage", maxCount: 1 },   { name: "otherImage", maxCount: 20 }, ]), rentController.rentUpdate);
